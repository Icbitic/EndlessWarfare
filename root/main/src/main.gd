# Copyright (c) 2021 Xiangkun Suen
# Distributed under the terms of the Mozilla Public License 2.0.
# https://github.com/Icbitic/EndlessWarfare/blob/main/LICENSE
#
# Upstream repo: https://github.com/Icbitic/EndlessWarfare
...
onready var test = preload("res://test/scene/test.tscn")
onready var test2 = preload("res://test/scene/test2.tscn")
onready var map = preload("res://game_world/scene/map.tscn")
onready var camera = preload("res://game_world/scene/camera.tscn")
...
func _add_commands():
	...
	Console.add_command("openuser", self, "_open_user_cmd")\
	.set_description("Open user folder in Explorer.")\
	.register()
